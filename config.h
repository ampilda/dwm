...
//#include "/home/ampilda/.cache/wal/colors-wal-dwm.h"
/* Helper macros for spawning commands */
#define SHCMD(cmd) { .v = (const char*[]){ "/bin/kitty", "-c", cmd, NULL } }
...
static const char *fonts[]               = { "Iosevka:size=13:style:Bold" };
static const char dmenufont[]            = "Iosevka:size=13:style:Bold";
...
static const Rule rules[] = {
	...
	RULE(.class = "discord", .monitor = 1 )
	RULE(.class = "mpv", .isfloating = 1, .floatpos = "0x 0y 640W 480H" )
...
static const char* pkill[] = {"pkill", "-RTMIN+10", "dwmblocks", NULL};
...
static const Key keys[] = {
  ...
  { 0,                            XK_ISO_Next_Group,          spawn,    {.v = pkill}}, 
	...
	{ MODKEY|Mod3Mask,              XK_u,          incrgaps,               {.i = +1 } },
	{ MODKEY|Mod3Mask|ShiftMask,    XK_u,          incrgaps,               {.i = -1 } },
	{ MODKEY|Mod3Mask,              XK_i,          incrigaps,              {.i = +1 } },
	{ MODKEY|Mod3Mask|ShiftMask,    XK_i,          incrigaps,              {.i = -1 } },
	{ MODKEY|Mod3Mask,              XK_o,          incrogaps,              {.i = +1 } },
	{ MODKEY|Mod3Mask|ShiftMask,    XK_o,          incrogaps,              {.i = -1 } },
